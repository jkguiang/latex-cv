...
\Section{\faSuitcase}{Experience}
  \SubHeadingListStart
     ...
     \Subheading
      ...
      \SubItem{}{Experimental Particle Physics}{Performed data analysis on proton-proton collision data collected with the CMS detector at the LHC as a part of a multinational collaboration. Managed 3 petabytes of CMS data stored at the UCSD Tier 2 computing facility which services thousands of scientists.}
      \ItemListStart
        \Item{}{VBS WWH Analysis}
          {Search for anomalous Higgs boson couplings in production of $W^{\pm}W^{\pm}H$ triboson process through vector boson scattering (VBS). Worked on all aspects of the analysis and contributed in particular to the software framework for this analysis and related analyses.}
      \ItemListEnd
      \SubItem{}{WLCG Cyberinfrastructure}{Prototyped the implementation and integration of cutting-edge technologies towards meeting the exascale demands of the HL-LHC era, working closely with experts at the SDSC and around the world.}
      \ItemListStart
        \Item{https://github.com/jkguiang/rucio-sense-prototype}{Rucio-SENSE Interoperation}
          {Pioneered the interoperation of exascale software-defined networking (SENSE) with the data management software (Rucio) used to manage petabytes of data across the WLCG.}
        \Item{https://github.com/jkguiang/us-cms-datalake}{US-CMS Data Lake}
          {Prototyped a federated data center concept (``Data Lake") that would reduce operational costs, amongst other logistical benefits, and enable HL-LHC-scale data storage in the U.S.}
      \ItemListEnd
      \SubItem{}{Radiology}{Worked with an interdisciplinary group of researchers using state-of-the-art methods to conceptualize and refine machine learning algorithms for analyzing CT scans towards clinical utility.}
      \ItemListStart
    ...
    \Subheading
      ...
      \ItemListStart
        ...
        \Item{https://github.com/jkguiang/AutoDQM}{AutoDQM}
          {Conceptualized, designed, and implemented a statistical tool for data quality management with an online graphical interface for ease of use.}
        \Item{https://journals.aps.org/prd/abstract/10.1103/PhysRevD.102.032002}{MilliQan}
          {Characterized the single-photoelectron (SPE) response of photomultiplier tubes used in the “MilliQan” experiment demonstrator. Developed software for simulating SPE responses.}
      \ItemListEnd
...
\Section{\faGroup}{Community}
  \SubHeadingListStart
      \Subheading
      {EXPAND}     {San Diego, CA}
      {Program Director/Co-founder} {Jan. 2020 -- Present}
      \ItemListStart
        \Item{https://center.ucsd.edu/programs/EXPAND.html}{Description}
        ...
        \Item{}{Activities}
          {Grew program from inception to being one of the main mentorship efforts for the U CSD Student Success Center. Directed every aspect of the program and wrote whitepaper. Interviewed and hired mentors.}
        \Item{}{Positions}
          {Program Director/Co-founder (Duration), Graduate Student Mentor (Spring, 2021)}
      \ItemListEnd
      \Subheading
      {Physics Graduate Council} {San Diego, CA}
      {Volunteer Representative} {Sept. 2020 -- Jul. 2021}
      \ItemListStart
        \Item{https://sites.google.com/a/physics.ucsd.edu/physics-graduate-council/}{Description}
          {The Physics Graduate Council (PGC) is a body of elected representatives which serves the interests of the physics graduate students of UCSD. It serves as the official liaison between the department administration and faculty and the graduate student body. Nominated as a volunteer representative for the 2020-21 academic year.}
        \Item{}{Activities}
          {Worked with PGC chairpersons to better organize an ongoing graduate student diversity initiative. Sat on the department's Climate Comittee and provided direct input/direction for their activities.}
        \Item{https://sites.google.com/a/physics.ucsd.edu/physics-graduate-council/representatives}{Positions}
          {Representative (Duration), Department Climate Committee Member (Sept. 2020 -- Apr. 2021)}
      \ItemListEnd
  \SubHeadingListEnd
%

%-----------TEACHING-----------------
\Section{\faBook}{Teaching and Mentorship}
  \SubHeadingListStart
      \Item{}{Undergraduates}{Taught a number of undergraduate students core skills in data analysis and programming.}
      \ItemListStart
        \Item{https://center.ucsd.edu/programs/expand/2020-expand-alumni.html}{Daniela Garcia}
          {Characterized NanoAOD read latency for an EXPAND project. (Spring, 2020-21)}
        \Item{https://center.ucsd.edu/programs/expand/2020-expand-alumni.html}{David Rovira}
          {Characterized NanoAOD read latency for an EXPAND project. (Spring, 2020-21)}
      \ItemListEnd
      \Item{}{Teaching Assistant}{Lead discussion and laboratory sections at UC San Diego. Prepared and presented lectures, proctored and graded exams, held office hours, and graded homework assignments.}
      \ItemListStart
        \Item{}{PHYS 12}
          {Non-major course on energy and the environment. (Fall, 2019-20)}
        \Item{}{PHYS 1AL}
          {Introductory mechanics laboratory. (Winter, 2019-20)}
      \ItemListEnd
  \SubHeadingListEnd
%
